...
instructionTableIO (Valid ctx) (Push r1) = (pushImpl (Valid ctx) r1, putStr "")
instructionTableIO ctx (Pop r1) = (popImpl ctx r1, putStr "")
instructionTableIO (Valid ctx) (Xor r1 r2) = (xorImpl (Valid ctx) r1 r2, putStr "")
...
instructionTableIO (Valid ctx) (MovPtr p1 p2) = (movPtrImpl (Valid ctx) p1 p2, putStr "")
...
instructionTableIO (Valid ctx) (MovStackAddr p1 p2) = (movStackAddrImpl (Valid ctx) p1 p2, putStr "")
instructionTableIO (Valid ctx) (MovFromStackAddr p1 p2) = (movFromStackAddrImpl (Valid ctx) p1 p2, putStr "")
